    ...
    function toggleDropdown(elementId) {
      ...
      document.addEventListener('DOMContentLoaded', function () {
        const albumId = getQueryParam('albumId');  // Obtener el ID del género de la URL
        ...
        fetch(apiUrl)
          ...
          .then(data => {
            ...
            tituloAlbum.textContent = `Album de ${data.name}`;  // Cambiar el título al nombre del género
              ...
              audios.forEach((audio, index) => {
                ...
                <div class="track-info">
                  ...
                  <div class="track-details">
                    <p>Genero: ${audio.genero? audio.genero.title : 'Sin Genero'}</p>
